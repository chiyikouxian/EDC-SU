...
- [ ] 5.3 Verify existing NAV and ADV flows still compile and remain behaviorally unchanged. Source inspection shows `app_state.c` integration is present, but this still needs a fresh CCS Theia build.
