...
#### Scenario: Default scale maps bridge range to chassis PID range

- **WHEN** `CHASSIS_TRACK_ERROR_SCALE` is defined (default 7)
...
- **WHEN** `TrackBridgeData_t.active_count >= CHASSIS_NODE_ACTIVE_COUNT_THRESHOLD` (default 6)
